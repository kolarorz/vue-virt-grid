...
import { createApp, reactive, shallowReactive as shallowReactive$1, ref as ref$1, provide, inject, shallowRef as shallowRef$1, onUpdated, watch as watch$1, defineComponent, openBlock, createElementBlock, toDisplayString, computed, createElementVNode, createCommentVNode, unref, normalizeClass, normalizeStyle, Fragment, renderList, createBlock, resolveDynamicComponent, withModifiers, createVNode, onMounted as onMounted$1, onBeforeUnmount as onBeforeUnmount$1, renderSlot, useSlots, getCurrentInstance, mergeProps, withCtx, render, createStaticVNode } from "vue";
    ...
    if (rightFixedColumns.length > 0) {
      for (let colIndex = 0; colIndex < rightFixedColumns.length; colIndex++) {
        ...
        tds.push(createVNode("td", {
          ...
          "style": `text-align: ${column.align}; right: ${headerCellInfo[column._id].fixOffset}px; ${getCellStyle(column)}`,
          "data-rowidx": rowIndex,
          "data-colidx": actualColIndex
        }, [getRenderCell({
          row,
...
const _sfc_main$9 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$a, mergeProps({ columns: columns.value }, attrs.value), {
        empty: withCtx(() => [
